...
export default function EditorIAPage() {
  ...
  async function saveTimeline() {
    ...
    try {
      ...
      setProject(queued); setMessage("Linha do tempo salva. Uma nova finalização profissional foi iniciada.");
    } catch (err) { setError(err instanceof Error ? err.message : "Falha ao salvar a linha do tempo."); }
    finally { setBusy(false); }
  }
  ...
  const stages = [
    ...
    { label: "Linha do tempo", icon: TimelineIcon },
            ...
            <div className="p-5">
              ...
              <details className="mt-5 rounded-lg border border-[#e4e7ec] bg-[#fafbfc]" open>
                ...
                <div className="space-y-4 border-t border-[#e4e7ec] p-4">
                  ...
                  <p className="text-[10px] leading-4 text-[#667085]">Referência de fluxo: corte automático por fala/ritmo, sincronia com a trilha, legendas automáticas e refinamento da linha do tempo, mantendo a identidade do ShortsFlow.</p>
                </div>
              </details>
