...
PLAN_CATALOG: dict[str, dict] = {
    "trial": {
        ...
        "featured": False,
        "features": [
            "30 minutos de vídeo original processado",
            "Até 3 Shorts no período de teste",
            "1 canal do YouTube",
            "Cortes com IA, transcrição e formato 9:16",
        ],
    },
    "creator": {
        "code": "creator",
        "name": "Creator",
        "description": "Para quem está começando a transformar vídeos em Shorts com IA.",
        ...
        "features": [
            "1 canal conectado",
            "180 minutos de vídeo processado por mês",
            "Até 30 Shorts por mês",
            "Cortes automáticos com IA",
            "Transcrição automática",
            "Formato automático 9:16",
            "Legendas",
            "Títulos e descrições com IA",
            "Publicação no YouTube",
            "Exportação sem marca ShortsFlow",
        ],
    },
    "pro": {
        "code": "pro",
        "name": "Pro",
        "description": "Mais escolhido para criadores e profissionais que publicam com frequência.",
        ...
        "features": [
            ...
            "Tudo do Creator",
            "Análise dos melhores momentos com IA",
            "Score de potencial do corte",
            "Títulos, descrições e hashtags com IA",
    ...
    "business": {
        "code": "business",
        "name": "Business",
        "description": "Para pequenas produtoras e empresas com múltiplas marcas.",
    ...
    "agency": {
        "code": "agency",
        "name": "Agency",
        "description": "Operação de alto volume para agências e vários clientes.",
