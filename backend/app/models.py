...
class TenantPlan(Base):
    ...
    billing_status: Mapped[str] = mapped_column(String(30), default="pending", index=True)
    billing_provider: Mapped[str] = mapped_column(String(30), default="legacy", index=True)
    ...
    asaas_checkout_id: Mapped[str | None] = mapped_column(String(120), nullable=True, index=True)
    asaas_customer_id: Mapped[str | None] = mapped_column(String(120), nullable=True, index=True)
    asaas_subscription_id: Mapped[str | None] = mapped_column(String(120), nullable=True, index=True)
    asaas_payment_id: Mapped[str | None] = mapped_column(String(120), nullable=True, index=True)
